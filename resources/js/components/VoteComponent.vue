    ...
    <div>
        <div>
             <span style="padding-right: 10px; font-weight: bold">
                 <svg @click="vote('up')" :class="{ 'thumbs-up-active': upvoted }" width="1em" height="2em" viewBox="0 0 16 16" class="thumbs-up" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
             ...
             <span style="font-weight: bold">
                 <svg @click="vote('down')" :class="{ 'thumbs-down-active': downvoted }" width="1em" height="2em" viewBox="0 0 16 16" class="thumbs-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    export default {
        ...
        computed: {
            ...
            upvoted() {
                ...
                return !!this.upvotes.find(v => v.user_id === __auth().id) // !! for boolean
            },
        ...
        methods: {
            vote(type) {
                ...
                if(__auth().id === this.entity_owner){
                    return alert('You cannot vote this video')
                }
