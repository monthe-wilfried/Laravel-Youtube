            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        @if($channel->editable())
                            <strong><a href="{{ route('channel.upload', $channel->id) }}"><i class="fa fa-upload"></i> Upload Videos</a></strong>
                        @endif
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                                ...
                                <div class="form-group justify-content-center">
                                    ...
                                    <p class="text-center text-justify" style="padding: 0 5px;">{{ $channel->description }}</p>
                                ...
                                @if($channel->editable())
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ $channel->name }}">
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror">{{ $channel->description }}</textarea>
                                        @error('description')
                                        <span class="invalid-feedback alert">
